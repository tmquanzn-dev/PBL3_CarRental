...
public class DashboardController {
    ...
    private void loadContractStatus() {
        try {
            double total = contractBLL.getTodayRevenue();
    ...
    private void setupRecentContractsTable() {
        ...
        colCustomer.setCellValueFactory(cellData -> {
            if (cellData.getValue().getId_customer() != null) {
                ...
                Customers c = customerBLL.findById(id);
        ...
        colVehicle.setCellValueFactory(cellData -> {
            if (cellData.getValue().getId_vehicle() != null) {
                ...
                Vehicles v = vehicleBLL.getVehicleById(id);
                ...
                if (empty || getTableRow() == null || getTableRow().getItem() == null) {
                    ...
                    if (contract.getStatus() != null) {
                        ...
                        switch (st) {
                            ...
                            default -> { pill.setText(st); pill.getStyleClass().add("status-gray"); }
                        }
                    }
                    setGraphic(pill);
                }
        ...
        colAction.setCellFactory(column -> new TableCell<>() {
            ...
            private final HBox pane = new HBox(12, btnView, btnPrint);
            {
                ...
                btnView.setOnAction(e -> showDetailPopup(getTableView().getItems().get(getIndex())));
            }
        ...
        tableContracts.setItems(
                FXCollections.observableArrayList(contractBLL.getRecentContracts(5))
        );
    }
