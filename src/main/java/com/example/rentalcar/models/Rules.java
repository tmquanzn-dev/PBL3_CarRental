...
public class Rules {
    ...
    public Rules(int id_rule, String rule_name, RuleType rule_type,
    ...
    public int getId_rule()                    { return id_rule; }
    public void setId_rule(int id_rule)        { this.id_rule = id_rule; }
    ...
    public void setRule_type(RuleType rt)      { this.rule_type = rt; }

    public double getMulti()                   { return multi; }
    public void setMulti(double multi)         { this.multi = multi; }
    ...
    public String getRuleTypeDisplay() {
        if (rule_type == null) return "--";
        return switch (rule_type) {
            case CUOI_TUAN -> "Cuối tuần";
            case NGAY_LE   -> "Ngày lễ";
            case KHAC      -> "Khác";
        };
    }
}